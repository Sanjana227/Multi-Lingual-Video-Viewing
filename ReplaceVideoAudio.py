...
class AudioReplacerGUI:
	...
	def __init__(self):
		...
		new_window.iconbitmap('G:\Training\MINI_FINAL\Multimodal Video Viewing\logo.ico')
		...
		self.label = customtkinter.CTkLabel(new_window, text="Select the Video, Audio, and Output Paths :", font=("Arial", 12, "bold"),text_color="#C5E384")
